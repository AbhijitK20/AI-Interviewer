      ...
      >
        <GlassCard className="p-8">
          ...
          >
            ...
            <h2 className="text-2xl font-bold" style={{ color: '#fff', fontWeight: 500 }}>Welcome back</h2>
            <p className="mt-1" style={{ color: 'rgba(255,255,255,.5)' }}>Sign in to continue your interview prep</p>
          </motion.div>
